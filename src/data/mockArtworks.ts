...
export const mockGuestbookEntries: GuestbookEntry[] = [
  ...
  {
    id: 'gb-5',
    authorName: 'Kotori Itsuka',
    message: "Commander's orders: stay warm, drink hot cocoa, and don't let Shido tease you too much!",
  ...
  },
  {
    id: 'gb-6',
    authorName: 'Natsumi',
    message: "Yoshino is my best friend in the whole wide world! Let's build a giant snow castle together!",
    createdAt: '2025-02-25',
    badgeIcon: '✨',
  },
  {
    id: 'gb-7',
    authorName: 'Kurumi Tokisaki',
    message: 'Ara ara~ What a delightful little sanctuary in the falling snow. Stay peaceful, little Yoshino-san.',
    createdAt: '2025-03-01',
    badgeIcon: '💙',
  },
  {
    id: 'gb-8',
    authorName: 'Origami Tobiichi',
    message: "Observation confirmed: The Hermit's sub-zero sanctuary is peaceful and safe. No AST threats detected.",
    createdAt: '2025-03-03',
    badgeIcon: '❄️',
  },
  {
    id: 'gb-9',
    authorName: 'Kaguya & Yuzuru',
    message: "Proclamation! 'This archive is truly magnificent!' Agree. Yuzuru also thinks Yoshino is adorable.",
    createdAt: '2025-03-05',
    badgeIcon: '🐰',
  },
  {
    id: 'gb-10',
    authorName: 'Reine Murasame',
    message: 'Heart rate stable, spirit wavelength serene. A very peaceful winter day, Yoshino.',
    createdAt: '2025-03-08',
    badgeIcon: '🍵',
  },
  {
    id: 'gb-11',
    authorName: 'Mana Takamiya',
    message: "Stay cozy, Yoshino-chan! I brought some sweet warm taiyaki for you and Yoshinon to share!",
    createdAt: '2025-03-10',
    badgeIcon: '✨',
  },
  {
    id: 'gb-12',
    authorName: 'Shido Itsuka',
    message: 'Yoshino, thank you for always bringing warmth and smiles to everyone. Let’s make snow rabbits tomorrow!',
